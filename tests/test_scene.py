...
class BaseSceneTest(unittest.TestCase):
    ...
    def test_unimplemented_method_load(self):
        ...
        try :
            ...
            self.assertEqual("the method load isn't overridden",message_exception)
    ...
    def test_unimplemented_method_unload(self):
        ...
        try :
            ...
            message_exception = str(message)
            self.assertEqual("the method unload isn't overridden",message_exception)
    ...
    def test_unimplemented_method_draw(self):
        ...
        try :
            ...
            message_exception = str(message)
            self.assertEqual("the method draw isn't overridden",message_exception)
    ...
    def test_unimplemented_method_update(self):
        ...
        try :
            ...
            message_exception = str(message)
            self.assertEqual("the method update isn't overridden",message_exception)
